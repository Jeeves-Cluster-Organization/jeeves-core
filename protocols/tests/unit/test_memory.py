...
class TestWorkingMemory:
    ...
    def test_create_working_memory(self):
        ...
        from protocols import WorkingMemory
    ...
    def test_working_memory_add_entity(self):
        ...
        from protocols import WorkingMemory, EntityRef
...
class TestFocusState:
    ...
    def test_set_focus(self):
        ...
        from protocols import WorkingMemory, FocusState, FocusType
...
class TestFocusType:
    ...
    def test_focus_types(self):
        ...
        from protocols import FocusType
