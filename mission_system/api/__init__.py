...
from mission_system.api import MissionRuntime, create_mission_runtime
...
from mission_system.config.registry import ConfigRegistry
from avionics.database.client import DatabaseClientProtocol, create_database_client
...
class MissionRuntime:
    ...
    #   from mission_system.contracts_core import create_pipeline_runner
