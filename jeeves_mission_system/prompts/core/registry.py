    ...
    def get_instance(cls) -> 'PromptRegistry':
        if cls._instance is None:
            ...
            generic_prompt_modules = [
                "jeeves_mission_system.prompts.core.versions.intent",
                "jeeves_mission_system.prompts.core.versions.planner",
                "jeeves_mission_system.prompts.core.versions.confirmation",
                "jeeves_mission_system.prompts.core.versions.critic",
            ]
