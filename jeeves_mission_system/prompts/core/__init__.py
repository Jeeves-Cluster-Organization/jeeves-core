...
try:
    from jeeves_mission_system.prompts.core.versions import confirmation  # noqa: F401
except (ImportError, FileNotFoundError):
    pass  # Ignore import errors to prevent blocking other prompts

try:
    from jeeves_mission_system.prompts.core.versions import intent  # noqa: F401
except (ImportError, FileNotFoundError):
    pass

try:
    from jeeves_mission_system.prompts.core.versions import planner  # noqa: F401
except (ImportError, FileNotFoundError):
    pass

try:
    from jeeves_mission_system.prompts.core.versions import critic  # noqa: F401
except (ImportError, FileNotFoundError):
    pass
