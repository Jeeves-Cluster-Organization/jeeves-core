...
# Import the servicer
from jeeves_mission_system.orchestrator import governance_service
...
def mock_registry(monkeypatch):
    ...
    monkeypatch.setattr(
        "jeeves_mission_system.orchestrator.governance_service.get_capability_resource_registry",
        lambda: registry
    )
    return registry
