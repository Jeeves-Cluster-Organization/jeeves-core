...
from jeeves_mission_system.api.health import HealthChecker, health_check_to_dict
...
from jeeves_mission_system.config.constants import PLATFORM_NAME, PLATFORM_DESCRIPTION, PLATFORM_VERSION
...
if settings.chat_enabled:
    from jeeves_mission_system.api.chat import router as chat_router, get_chat_service
...
from jeeves_mission_system.api.governance import router as governance_router, get_tool_health_service
