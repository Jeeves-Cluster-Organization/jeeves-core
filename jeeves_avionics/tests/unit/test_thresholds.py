...
class TestConfirmationThresholds:
    ...
    def test_confirmation_detection_confidence_range(self):
        ...
        from jeeves_avionics.thresholds import CONFIRMATION_DETECTION_CONFIDENCE
    ...
    def test_confirmation_interpretation_confidence_range(self):
        ...
        from jeeves_avionics.thresholds import CONFIRMATION_INTERPRETATION_CONFIDENCE
    ...
    def test_confirmation_timeout_is_positive(self):
        ...
        from jeeves_avionics.thresholds import CONFIRMATION_TIMEOUT_SECONDS
...
class TestPlanningThresholds:
    ...
    def test_plan_confidence_range(self):
        ...
        from jeeves_avionics.thresholds import PLAN_MIN_CONFIDENCE, PLAN_HIGH_CONFIDENCE
    ...
    def test_max_retry_attempts_is_positive(self):
        ...
        from jeeves_avionics.thresholds import MAX_RETRY_ATTEMPTS
...
class TestSearchThresholds:
    ...
    def test_fuzzy_match_min_score(self):
        ...
        from jeeves_avionics.thresholds import FUZZY_MATCH_MIN_SCORE
    ...
    def test_semantic_search_min_similarity(self):
        ...
        from jeeves_avionics.thresholds import SEMANTIC_SEARCH_MIN_SIMILARITY
...
class TestL7GovernanceThresholds:
    ...
    def test_min_invocations_is_positive(self):
        ...
        from jeeves_avionics.thresholds import TOOL_MIN_INVOCATIONS_FOR_STATS
    ...
    def test_quarantine_duration_is_positive(self):
        ...
        from jeeves_avionics.thresholds import TOOL_QUARANTINE_DURATION_HOURS
...
class TestWorkingMemoryThresholds:
    ...
    def test_open_loop_stale_days_is_positive(self):
        ...
        from jeeves_avionics.thresholds import OPEN_LOOP_STALE_DAYS
...
class TestLatencyBudgets:
    ...
    def test_max_request_latency_is_positive(self):
        ...
        from jeeves_avionics.thresholds import MAX_REQUEST_LATENCY_MS
