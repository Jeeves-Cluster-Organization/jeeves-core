...
LLM provider abstraction layer supporting multiple backends: OpenAI, Anthropic, LlamaCpp, Azure, and local llamaserver. Implements `LLMProviderProtocol` from `protocols`.
