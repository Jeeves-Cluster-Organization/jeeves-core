...
pytest avionics/tests -m "not heavy and not requires_ml and not requires_docker"
...
```bash
pytest avionics/tests/unit/llm -m "not requires_azure and not requires_openai"
...
```bash
pytest avionics/tests -m "requires_docker"
...
```bash
pytest avionics/tests -m "requires_ml"
...
```bash
pytest avionics/tests -m "not requires_docker"
```
...
```bash
# Skip ML tests
pytest avionics/tests -m "not requires_ml"
...
```bash
pytest avionics/tests -m "not requires_azure"
```
...
pytest avionics/tests/unit/llm -m "not requires_azure"

# Watch mode
pytest-watch avionics/tests/unit/llm
```
...
pytest avionics/tests -m "integration"
```
