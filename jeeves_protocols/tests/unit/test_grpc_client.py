...
def mock_grpc():
    ...
    with patch("jeeves_protocols.grpc_client.grpc") as mock_grpc_module:
        # Mock channel
...
class TestGrpcGoClientConnection:
    ...
    def test_connect_success(self, mock_grpc):
        ...
        with patch("jeeves_protocols.grpc_client.grpc", mock_grpc):
            with patch.dict("sys.modules", {"jeeves_protocols.grpc_stub": MagicMock()}):
...
class TestModuleFunctions:
    ...
    def test_get_client_returns_singleton(self):
        ...
        import jeeves_protocols.grpc_client as module
