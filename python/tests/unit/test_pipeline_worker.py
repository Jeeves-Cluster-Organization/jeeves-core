...
from jeeves_airframe.pipeline_worker import PipelineWorker, WorkerResult
from jeeves_airframe.kernel_client import (
    OrchestratorInstruction,
    OrchestrationSessionState,
    AgentExecutionMetrics,
)
from jeeves_airframe.protocols.types import Envelope
...
async def test_pipeline_worker_handles_session_init_failure(mock_kernel_client, mock_agents, mock_envelope, pipeline_config):
    ...
    from jeeves_airframe.kernel_client import KernelClientError
