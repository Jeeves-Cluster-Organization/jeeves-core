...
from jeeves_airframe.context import AppContext, SystemClock
from jeeves_airframe.logging import configure_logging
from jeeves_airframe.settings import Settings, get_settings
from jeeves_airframe.feature_flags import FeatureFlags, get_feature_flags
from jeeves_airframe.protocols import ExecutionConfig, ContextBounds, OrchestrationFlags
from jeeves_airframe.protocols import get_capability_resource_registry
from jeeves_airframe.config.registry import ConfigRegistry

# KernelClient for Rust kernel integration
from jeeves_airframe.kernel_client import KernelClient, DEFAULT_KERNEL_ADDRESS

if TYPE_CHECKING:
    from jeeves_airframe.protocols import AgentToolAccessProtocol
...
def create_app_context(
    ...
    # Build root logger (jeeves_airframe provides structlog wrapper)
    from jeeves_airframe.logging import create_logger
    ...
    if feature_flags.enable_tracing:
        from jeeves_airframe.observability.otel_adapter import (
            init_global_otel,
    ...
    from jeeves_airframe.llm.factory import create_llm_provider_factory as _create_llm_factory
    ...
    from jeeves_airframe.ipc import IpcTransport
    ...
    if feature_flags.use_redis_state:
        from jeeves_airframe.redis.connection_manager import ConnectionManager
        ...
        from jeeves_airframe.redis.connection_manager import InMemoryStateBackend
...
def create_tool_executor_with_access(
    ...
    """
    from jeeves_airframe.wiring import ToolExecutor
