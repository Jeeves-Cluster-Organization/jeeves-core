...
from jeeves_airframe.protocols import LoggerProtocol, RequestContext
from jeeves_airframe.logging import get_current_logger as get_logger

if TYPE_CHECKING:
    from jeeves_airframe.orchestrator.agent_events import AgentEventEmitter
...
class EventContext:
    ...
    async def emit_flow_started(self) -> None:
        ...
        if self.agent_event_emitter:
            from jeeves_airframe.orchestrator.agent_events import AgentEvent, AgentEventType
