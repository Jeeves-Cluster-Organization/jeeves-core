...
from jeeves_airframe.logging import get_current_logger as get_logger
from jeeves_airframe.utils.serialization import datetime_to_ms
from jeeves_airframe.protocols import LoggerProtocol, get_capability_resource_registry
...
class HealthServicer:
    ...
    async def get_memory_layers(self) -> Dict[str, Any]:
        ...
        """
        try:
            from jeeves_airframe.protocols.capability import get_capability_resource_registry
            registry = get_capability_resource_registry()
