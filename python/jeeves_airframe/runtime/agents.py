...
from jeeves_airframe.protocols.interfaces import LLMProviderProtocol

if TYPE_CHECKING:
    from jeeves_airframe.protocols import Envelope, AgentConfig, PipelineConfig
...
class Agent:
    ...
    async def stream(self, envelope: Envelope) -> AsyncIterator[Tuple[str, Any]]:
        ...
        """
        from jeeves_airframe.protocols import PipelineEvent
        from jeeves_airframe.protocols import TokenStreamMode
    ...
    async def _call_llm_stream(self, envelope: Envelope) -> AsyncIterator[str]:
        ...
        from jeeves_airframe.protocols import AgentOutputMode
...
def create_envelope(
    ...
    import uuid
    from jeeves_airframe.utils import utc_now
    from jeeves_airframe.protocols import Envelope  # Runtime import to avoid circular dependency

    # Import RequestContext at runtime to avoid circular dependency
    from jeeves_airframe.protocols import RequestContext as RC
