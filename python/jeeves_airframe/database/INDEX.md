...
**Note:** Redis support is available for distributed bus functionality (see `jeeves_airframe/distributed/`).
...
**Note:** Implementation classes (`PostgreSQLClient`, `RedisClient`, etc.) and repository patterns are in `jeeves_airframe/` package.
