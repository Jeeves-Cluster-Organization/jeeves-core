"""Configuration package for jeeves_airframe.
...
from jeeves_airframe.config.constants import (
    # Platform Identity
    PLATFORM_NAME,
    PLATFORM_VERSION,
...
from jeeves_airframe.config.agent_profiles import (
    AgentLLMConfig,
    ThresholdProfile,
    AgentProfile,
    get_agent_profile,
...
from jeeves_airframe.config.registry import (
    ConfigRegistry,
    ConfigKeys,
)
