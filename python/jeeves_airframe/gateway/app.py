...
from jeeves_airframe.observability.tracing import init_tracing, instrument_fastapi, shutdown_tracing
...
async def lifespan(app: FastAPI) -> AsyncIterator[None]:
    ...
    try:
        ...
        # by the composition root (jeeves_airframe.bootstrap) via app.state.
        ...
        if ctx is not None:
            ...
            if ctx.kernel_client is not None:
                from jeeves_airframe.services.interrupt_service import KernelInterruptService
...
from jeeves_airframe.middleware.body_limit import BodyLimitMiddleware

app.add_middleware(BodyLimitMiddleware, max_bytes=config.max_request_body_bytes)

# Metrics middleware
from jeeves_airframe.observability.metrics import record_http_request
...
from jeeves_airframe.gateway.routers import chat, governance, interrupts
...
if __name__ == "__main__":
    ...
    uvicorn.run(
        "jeeves_airframe.gateway.app:app",
