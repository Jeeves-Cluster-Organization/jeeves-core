...
from jeeves_airframe.gateway.sse import SSEStream, merge_sse_streams
...
def _classify_event_category(event_type: str) -> "EventCategory":
    from jeeves_airframe.protocols.events import EventCategory
...
async def _publish_unified_event(event: dict):
    from jeeves_airframe.gateway.event_bus import gateway_events
    from jeeves_airframe.protocols.events import Event, EventCategory, EventSeverity
    from jeeves_airframe.protocols.interfaces import RequestContext
