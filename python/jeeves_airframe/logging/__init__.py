...
Base logging functionality comes from jeeves_airframe.utils.logging.
Real OpenTelemetry tracing is provided by jeeves_airframe.observability.

Constitutional Compliance:
- Infrastructure owns OTEL configuration flag
...
Usage:
    from jeeves_airframe.logging import create_logger, configure_logging
...
from jeeves_airframe.utils.logging import (
    Logger,
...
def configure_logging(
    ...
    *,
    ...
    For actual OpenTelemetry tracing, use jeeves_airframe.observability.
...
from jeeves_airframe.logging.adapter import StructlogAdapter, create_structlog_adapter

# Re-export from context module (ADR-001)
from jeeves_airframe.logging.context import (
    bind_logger_context,
    request_context,
)
