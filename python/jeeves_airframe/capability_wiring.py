...
Usage:
    ...
    from jeeves_airframe.capability_wiring import register_capability
...
def wire_infra_routers(app_context) -> None:
    ...
    """
    from jeeves_airframe.gateway.routers.governance import router as gov_router, get_tool_health_service
