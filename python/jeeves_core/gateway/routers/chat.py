...
from jeeves_core.gateway.sse import SSEStream, merge_sse_streams
from jeeves_core.logging import get_current_logger
from jeeves_core.utils.serialization import ms_to_iso
...
def _classify_event_category(event_type: str) -> "EventCategory":
    from jeeves_core.protocols.events import EventCategory
...
async def _publish_unified_event(event: dict):
    from jeeves_core.gateway.event_bus import gateway_events
    from jeeves_core.protocols.events import Event, EventCategory, EventSeverity
