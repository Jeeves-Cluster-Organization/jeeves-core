...
Base logging functionality comes from jeeves_core.utils.logging.
Real OpenTelemetry tracing is provided by jeeves_core.observability.
...
Usage:
    from jeeves_core.logging import create_logger, configure_logging
...
from jeeves_core.utils.logging import (
    Logger,
...
if TYPE_CHECKING:
    from jeeves_core.feature_flags import FeatureFlags
...
def configure_logging(
    ...
    *,
    ...
    For actual OpenTelemetry tracing, use jeeves_core.observability.
...
from jeeves_core.logging.adapter import StructlogAdapter, create_structlog_adapter
