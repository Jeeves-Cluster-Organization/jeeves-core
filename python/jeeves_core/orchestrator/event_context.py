...
from jeeves_core.protocols import LoggerProtocol, RequestContext
from jeeves_core.logging import get_current_logger as get_logger

if TYPE_CHECKING:
    from jeeves_core.orchestrator.agent_events import AgentEventEmitter
...
class EventContext:
    ...
    async def emit_flow_started(self) -> None:
        ...
        if self.agent_event_emitter:
            from jeeves_core.orchestrator.agent_events import AgentEvent, AgentEventType
    ...
    async def emit_agent_reasoning(
        ...
        try:
            from jeeves_core.feature_flags import get_feature_flags
