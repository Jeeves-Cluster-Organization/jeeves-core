...
from memory_module.services.nli_service import NLIService, get_nli_service

# Lazy import: EmbeddingService requires sentence-transformers (1.5GB+ ML dep)
# Import directly when needed: from memory_module.services.embedding_service import EmbeddingService
